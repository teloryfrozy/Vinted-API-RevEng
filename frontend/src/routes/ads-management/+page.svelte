...
<div class="mx-auto max-w-7xl px-4 py-8">
      ...
      <div class="flex">
        ...
        <div class="ml-3">
          ...
          <div class="mt-2 text-sm text-yellow-700">
            <p>Certaines fonctionnalités nécessitent votre token Vinted et/ou vos identifiants IMAP. Configurez-les dans les <a href="/settings" class="font-medium text-yellow-800 underline hover:text-yellow-900">paramètres</a>.</p>
          </div>
        </div>
  ...
  <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
    ...
    <div class="rounded-lg bg-white p-6 shadow">
      ...
      <p class="mb-4 text-sm text-gray-600">Automatisez la repose de vos annonces programmées en plusieurs exemplaires. Évitez les tâches répétitives et chronophages.</p>
      <button class="inline-flex w-full items-center justify-center space-x-2 rounded-md bg-purple-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
        <ShoppingBag class="h-5 w-5" />
        <span>Activer la vente auto</span>
      </button>
    </div>
    ...
    <div class="rounded-lg bg-white p-6 shadow">
      ...
      <p class="mb-4 text-sm text-gray-600">Remontez vos annonces en tête de liste sur Vinted. Rafraîchissez une sélection ou toutes vos annonces en un clic.</p>
    ...
    <div class="rounded-lg bg-white p-6 shadow">
      ...
      <p class="mb-4 text-sm text-gray-600">Gérez efficacement vos annonces en supprimant les articles vendus ou en faisant un grand ménage de votre profil.</p>
      <div class="grid grid-cols-2 gap-3">
        <button class="inline-flex items-center justify-center space-x-2 rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">

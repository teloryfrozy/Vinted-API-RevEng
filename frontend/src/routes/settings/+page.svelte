      ...
      <div class="space-y-4">
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            />
            <button class="inline-flex items-center rounded-r-md border border-l-0 border-gray-300 bg-gray-50 px-3 text-gray-500 hover:bg-gray-100">
              <Key class="h-5 w-5" />
            </button>
          </div>
          <p class="mt-2 text-sm text-gray-500">Le token est nécessaire pour automatiser les actions sur Vinted</p>
        </div>
      </div>
    </div>
  </div>
